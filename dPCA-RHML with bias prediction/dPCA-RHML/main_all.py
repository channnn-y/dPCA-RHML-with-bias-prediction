...
# --traj_file='nore1.nc' --top_file='nore.pdb' --n_clusters=3 --batch_size=8 --epochs=10 --print_detail=1 --print_acc='True' --save_models=0 --atom_file='atom' --res_file='res'
parser = argparse.ArgumentParser(description='dPCA-RHML')
